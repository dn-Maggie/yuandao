...
$(function() {
	...
	$("#submit").click(function() {
		...
		var options = {
			url : "<m:url value='/empCost/addEmpCost.do'/>",
			type : "post",
				dataType:"json",
				success : function(d) {
					if(d.status){
			...
			<div class="center_body ui-table ui-widget ui-corner-all ui-border">
				...
				<table class="table">
					<tr>
						...
						<td class="inputTd">
							<div class="time_bg" style="width: 168px;">
								<input type="text" class="search_time150 valid text" name="month" id="edit_month" >
					...
					<tr class="hiddenRow">	
						...
						<td class="inputTd">
							<input id="edit_empDept" name="empDept" type="text" class="text" list="orgList" onchange="getEmpByOrgID(this,this.value);"/>
							<datalist id="orgList">
						...
						<td class="inputTd">
							...
							<input id="edit_empName" name="empName" 
